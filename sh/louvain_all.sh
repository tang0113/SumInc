...
for name in friendster #uk-2002 uk-2005 arabic-2005 it-2004 gsh-2015-tpd sk-2005 webbase-2001 #soc-livejournal
do
    # name: {uk-2002, europe_osm, road_usa}
    percentage=0.0000 # 0.3000 0.4000
    max_comm_size=100000000 # it-2004:10000,gsh-2015-tpd:30000,sk-2005:100000,others: 5000
    max_level=2 # web-graph: 2, road-graph: 4
    fix= #_ud #.random
    beta=0.80
    # inc
    ipath=${root_path}/dataset/large/${name}/${percentage}/${name}${fix}.base
    opath=${root_path}/dataset/louvain_bin/large_${name}_${percentage}${fix}
    # no-inc
