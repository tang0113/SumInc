...
dataset_path=/mnt2/neu/yusong/dataset/expr_data_10
app=sssp
update_rate=0.0001
type=push
app_concurrency=16
...
do
    ...
    #------------------test
    # name=uk-2005 # test_mirror_exit europe_osm_small europe_osm_small_1b europe_osm_small_20m
    # max_node_num=5000
    # update_rate=0.0001
    # mirror_k=2
    # min_node_num=2
