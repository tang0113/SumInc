...
def main():
    ...
    # cmd: python3 gen_inc2_batch.py /mnt2/neu/yusong/dataset/large/google/google_w_ud.e 10000 -w=0
    ...
    fp_base = open('%s/%d/%s.base' % (prefix, change_size, base), 'w')
    fp_append = open('%s/%d/%s.update' % (prefix, change_size, base), 'w')
    fp_updated = open('%s/%d/%s.updated' % (prefix, change_size, base), 'w')
