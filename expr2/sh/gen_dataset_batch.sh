...
for name in web-google # uk-2005 arabic-2005 it-2004 gsh-2015-tpd sk-2005 webbase-2001 #europe_osm
do
    ...
    do
    {
        ...
        do
        {
            python3 ${python_path}/gen_inc2_batch.py ${dataset_path}/${name}/${name}.e ${rate} -w=${weight} 
        } #&
        done
    } #&
    done
...
# for name in web-google # road_usa # uk-2002
# do
#     for rate in 10 100 1000 #0.01 0.001 0.0001
#     do
#     {
#         for weight in 1 0 # 1 # weight
#         do
#         {
#             cmd="python3 ${python_path}/gen_inc2_batch.py ${dataset_path}/${name}/${name}.mtx ${rate} -w=${weight} -header"
#             echo $cmd
#             eval $cmd
#         } &
#         done
